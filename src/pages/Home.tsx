import {
  ...
  Quote, ArrowRight, Sparkles, ChevronLeft, Instagram, ExternalLink, Play
} from 'lucide-react'
      ...
      <section className="py-16 md:py-20 bg-slate-900 text-white relative overflow-hidden">
        <div className="max-w-[1200px] mx-auto px-4 relative z-10">
          <div className="text-center max-w-2xl mx-auto mb-12">
            <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-gradient-to-r from-pink-500/20 to-purple-500/20 border border-pink-500/30 text-pink-400 text-xs font-bold uppercase tracking-wider mb-4">
              <Instagram className="w-4 h-4 text-pink-500" />
              <span>Watch Our Impact</span>
            </div>
            <h2 className="text-3xl md:text-4xl font-bold font-serif text-white mb-4">
              Latest Ground Coverage on <span className="text-pink-500">Instagram</span>
            </h2>
            <p className="text-slate-400 text-sm md:text-base">
              Follow <strong className="text-white">@alaqdaswelfare</strong> on Instagram for live video updates, ration distribution drives, and community welfare stories.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            {instagramReels.map((reel) => (
              <div
                key={reel.id}
                className="bg-slate-950/80 rounded-3xl overflow-hidden shadow-2xl border border-white/10 flex flex-col group hover:border-pink-500/50 transition-all duration-300"
              >
                <div className="relative aspect-[9/14] max-h-[460px] w-full overflow-hidden bg-black flex items-center justify-center">
                  <iframe
                    src={reel.embedUrl}
                    title={reel.title}
                ...
                <div className="p-5 bg-slate-900 border-t border-white/10 flex items-center justify-between gap-4">
                  <div className="min-w-0">
                    <h3 className="text-sm font-bold text-white truncate">{reel.title}</h3>
                    <p className="text-xs font-medium text-pink-400 mt-0.5">@alaqdaswelfare</p>
                  </div>
                  <a
                    href={reel.url}
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex-shrink-0 flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-pink-500 via-rose-500 to-purple-600 hover:opacity-90 text-white font-bold text-xs rounded-xl transition-all shadow-md active:scale-95"
                  >
          ...
          <div className="mt-10 text-center">
            <a
              href="https://www.instagram.com/alaqdaswelfare?igsh=MXBrdjNwNGhraDJvbQ=="
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2.5 px-6 py-3 rounded-xl bg-white/10 hover:bg-white/20 border border-white/15 text-white font-bold text-xs uppercase tracking-wider transition-all hover:scale-105"
            >
              <Instagram className="w-4 h-4 text-pink-500" />
              Follow Us on Instagram for More Videos
